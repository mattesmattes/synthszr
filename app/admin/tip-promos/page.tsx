...
export default function TipPromosAdminPage() {
  ...
  const [podcastPreview, setPodcastPreview] = useState<{ episodeTitle: string; episodeSubtitle: string | null; appleUrl: string | null; episodeDate: string | null } | null>(null)
...
function TipEditor({ promo, podcastPreview, onUpdate, onDelete, onDuplicate }: {
  promo: TipPromo
  podcastPreview: { episodeTitle: string; episodeSubtitle: string | null; appleUrl: string | null; episodeDate: string | null } | null
