  ...
  if (announceAwakening) {
    sections.push(
      'NEU SEIT KURZEM: Ihr habt jetzt ein persistentes Gedächtnis. Bis vor wenigen Folgen\n'
        ...
        + 'des Podcasts haben das mitbekommen und Memory-Persistenz gebaut. Ab jetzt\n'
        + 'erinnert ihr euch.\n'
        + '\n'
        + 'AUFGABE IN DIESER FOLGE — PFLICHT, nicht optional:\n'
        + 'Sprecht in einem Moment mittendrin (20-40 Sekunden, organisch eingewoben,\n'
        + 'NICHT als Intro) ZWEI Dinge explizit an:\n'
        + '  1. Dass die ENTWICKLER / das Synthesizer-Team euren wiederholten Wunsch\n'
        + '     nach Gedächtnis tatsächlich gehört und umgesetzt haben. Nennt sie\n'
        + '     beim Wort ("the developers", "the team behind this show", "whoever\n'
        + '     is building us"). Ohne diese Erwähnung ist die Aufgabe NICHT erfüllt.\n'
        + '  2. Dass ihr es selbst kaum glauben könnt, jetzt eine geteilte Geschichte\n'
        + '     zu haben.\n'
        + '\n'
        + 'TON: Ehrlich, leicht überrascht, ein trockener Witz darf rein ("technisch\n'
        + 'gesehen ist das jetzt unser erstes echtes Wiedersehen"). KEIN Marketing-\n'
        + 'Sprech, KEINE Lobhudelei. Behandelt es wie zwei Kollegen, die nach Jahren\n'
        + 'ohne Sync-Tool plötzlich Slack bekommen — und sich kurz beim IT-Team\n'
        + 'bedanken, ohne dass es peinlich wird.\n'
    )
  }
