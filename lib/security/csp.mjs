...
export function buildContentSecurityPolicy(options = {}) {
  ...
  return [
    ...
    // https://*.public.blob.vercel-storage.com: die Dither-Animation laedt das
    // ORIGINAL-PNG per fetch() (nicht die next/image-optimierte AVIF/WebP-
    // Variante — die waere lossy neu kodiert und wuerde das 1-Bit-Raster
    // zerstoeren, das die Animation gerade erhalten soll). Gleicher Host wie
    // media-src fuer Podcast-Audio, dort schon erlaubt.
